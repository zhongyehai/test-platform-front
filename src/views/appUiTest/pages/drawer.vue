...
<script>
import elementManage from '@/views/appUiTest/element'

import {postPage, putPage, copyPage} from '@/apis/appUiTest/page'
import {getModule} from "@/apis/appUiTest/module";
import {elementList} from "@/apis/appUiTest/element";
