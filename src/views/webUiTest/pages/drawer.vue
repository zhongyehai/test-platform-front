...
<script>
import elementManage from '@/views/webUiTest/element'

import {postPage, putPage, copyPage} from '@/apis/webUiTest/page'
import {getModule} from "@/apis/webUiTest/module";
import {elementList} from "@/apis/webUiTest/element";
