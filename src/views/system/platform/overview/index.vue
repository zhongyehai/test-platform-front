    ...
    useCardRes.value = [
      {
        title: '人工触发次数',
        color: '#36b9cc',
        icon: 'iconfont icon-testwodexiao',
        total: response.data.page_trigger_count
      },
      {
        title: '人工通过率',
        color: '#4e73df',
        icon: 'iconfont icon-testcharts-curve',
        total: response.data.page_trigger_pass_rate
      },
      {
        title: '巡检次数',
        color: '#1cc88a',
        icon: 'iconfont icon-testremind-btn-fill',
        total: response.data.patrol_count
      },
      {
        title: '巡检通过率',
        color: '#f6c23e',
        icon: 'iconfont icon-testcharts-line',
        total: response.data.patrol_pass_rate
      }
    ]
  })
}
