<template>
  ...
  <el-dialog
    ...
    <el-checkbox-group v-model="checkedOptions" @change="handleCheckedCitiesChange">
      <el-checkbox v-for="(value, key) in apiOptions" :label="key" :key="key">{{ value }}</el-checkbox>
    </el-checkbox-group>
    <span slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          @click="pullProject.yapi_id ? pullByYapi(pullProject) : pullBySwagger(pullProject)">确定</el-button>
      </span>
  </el-dialog>
