<template>
  <el-table :data="caseVariables" :height="tableHeight" stripe style="width: 100%" size="mini">
    ...
    <el-table-column :show-overflow-tooltip="true" prop="key" label="key" size="mini" width="200">
      <template slot-scope="scope">
        <span> {{ scope.row.key }} </span>
      </template>
    </el-table-column>

    <el-table-column :show-overflow-tooltip="true" prop="value" label="value" size="mini" width="400">
      <template slot-scope="scope">
        <el-input
          v-if="canEdite"
    ...
    <el-table-column :show-overflow-tooltip="true" prop="value" label="数据类型" size="mini" width="180">
      <template slot-scope="scope">
